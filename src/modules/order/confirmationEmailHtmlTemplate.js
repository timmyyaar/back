...
const getConfirmationEmailHtmlTemplate = (
  ...
  return `<div style="padding: 24px; font-size: 16px;">
                    ...
                    <div style="display: flex; padding-bottom: 6px; border-bottom: 2px solid #C6D3FF;">
                        ...
                        <img src="cid:bubbles@nodemailer.com" alt="" style="margin-left: auto; height: 80px; width: 80px;" class="mobile-none"/>
                    </div>
                    <div style="display: flex;">
                        <div>
                            ...
                            <ul>${WHAT_WE_DONT_DO.map(
                                ({ title, description }) => `
                                    <li style="margin-bottom: 16px;">
                                        <b style="color: black;">${locales[title]}: </b>
                        ...
                        <img src="cid:cleaners@nodemailer.com" alt="Cleaners" style="margin-top: auto; margin-left: 24px;" class="mobile-none"/>
                    </div>
                </div>`;
};
